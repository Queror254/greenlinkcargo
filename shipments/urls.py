...
from .views import getall_shipment, createshipment_view, shipment_detail, update_shipment, track_shipment, generate_invoice, invoice_detail, generate_invoice_pdf
